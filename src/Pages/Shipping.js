...
export default function Shipping(props) {
    ...
    const zipValidation = () => {
        if (props.customer.zip) {
            if (
                digits_only(props.customer.zip) &&
    ...
    const grandTotal = () => {
        let sum = (
            parseFloat(props.customer.shipping) +
            total +
            taxesValue
        ).toFixed(2);
    ...
    const apiCall = () => {
        axios
            .get(
                "https://port-3000-aincbootcampapi-ianrios529550.codeanyapp.com/api/store/shippings"
            )
    ...
    return (
        <Form
            className="m-3 border border-dark border-2 p-3"
            noValidate
        ...
        >
            ...
            <Row className="mb-3">
                ...
                <Form.Group as={Col}>
                    ...
                    <Form.Control
                        className={zipValidation() ? "is-valid" : "is-invalid"}
                        id="zip"
            ...
            <Form.Group as={Col}>
                ...
                <Form.Select
                    id="shipping"
                    value={props.customer.shipping || -1}
                    onChange={handleChange}
                >
            ...
            <Container className="m-2 border border-dark border-2">
                ...
                <Row>
                    ...
                    <Col className="col-3 fw-bold">
                        ${parseFloat(props.customer.shipping).toFixed(2)}
                    </Col>
                </Row>
                <Row>
                    <Col className="fw-bolder col-9">Taxes:</Col>
                    <Col className="col-3 fw-bold">
                        ${taxesValue.toFixed(2)}
                    </Col>
                </Row>
                <Row>
                    <Col className="fw-bolder col-9"> Grand Total:</Col>
                    <Col className="col-3 fw-bold">
                        ${props.customer.total || 0}
                    </Col>
                </Row>
            </Container>
